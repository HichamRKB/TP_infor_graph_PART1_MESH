...
import com.example.infograph.TriangleMeshHelper.SectionType;
import com.example.infograph.TriangleMeshHelper.TextureType;
import com.example.infograph.Patterns.CarbonPatterns;
import com.example.infograph.Palette.ColorPalette;
...
import static com.example.infograph.Palette.DEFAULT_COLOR_PALETTE;
import static com.example.infograph.TriangleMeshHelper.*;
...
public abstract class TexturedMesh extends MeshView implements TextureMode {
    ...
    public void updateF(List<Number> values) {
        ...
        MeshHelper mh = null; List<Point3D> traslate = null; float[] points = new float[0]; Maillage m1 = null; Maillage m2 = null;
        Maillage.mergeMesh(mh,traslate,points,m2,m1);
        updateTextureOnFaces();
