...
public class ToreMesh extends Maillage {
    ...
    public ToreMesh(double radius, double tRadius) {
        this(DEFAULT_DIVISIONS, DEFAULT_T_DIVISIONS, radius, tRadius);
    }

    public ToreMesh(int rDivs, int tDivs, double radius, double tRadius) {
    ...
    public static TriangleMesh createTorus(
            int radiusDivisions,
            int tubeDivisions,
            float radius,
            float tRadius,
