       ...
       // capsule.setTextureModeVertices3D(1530, p -> p.f);
        ...
        btn1.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent actionEvent) {
                ...
                cylinder.setMaterial(new PhongMaterial(Color.CHOCOLATE));
        ...
        btn3.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent actionEvent) {
               ...
               // tore.setMaterial(new PhongMaterial(Color.IVORY));
                Tore tore1 = new Tore(200, 100, 10, 5);
                tore1.setMaterial(new PhongMaterial(Color.IVORY));
        ...
        Label t = new Label("TIME Generated");
        Label t1 = new Label("PRIMITIVES");
        Label t2 = new Label("VERTEXES");
        Label t3 = new Label("NUMBERS OF TRIANGLES");

        final ToolBar toolBar = new ToolBar(btn1,btn2,btn3,btn4,button,combo,t,txt,t1,txt1,t2,txt2,t3,txt3);
        toolBar.setOrientation(Orientation.VERTICAL);
        final BorderPane borderPane = new BorderPane();
        borderPane.setTop(toolBar);
        toolBar.setStyle("-fx-border-color: blue");
        borderPane.setCenter(pane3D);
        pane3D.setStyle("-fx-border-color: yellow");
